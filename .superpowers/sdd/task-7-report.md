...
- Added Electron Builder configuration for the Electron main-process and renderer files, with the backend copied to application resources as `backend`; macOS produces DMG and Windows produces NSIS packages under `dist-electron`.
